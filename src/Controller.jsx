...
export function Controller(props) {
	...
	useEffect(() => {
		if (isPaused) {
			document.title = "25ji-Nightcord-Playlist";
		} else {
			document.title = `25ji-Nightcord-Playlist | ${queueManager.currentSong?.name ?? "25ji-Nightcord-Playlist"} - ${queueManager.currentSong?.artist}`;
		}
